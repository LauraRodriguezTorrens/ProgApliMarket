...
public class Controlador1 {
   ...
   private Controlador1(){
    ...
    private static Controlador1 instance = new Controlador1(); 
   
 public static Controlador1 getInstance(){
        return instance;
...
//   conectar cc =new conectar();
//    List listarCat = new ArrayList();
//    listarCat = cc.ListaCategorias();
//    return listarCat;
//   
//}

/// yoooooooo ALTAAA JUEGOOOOOOOOOO
...
public void registrarJ(Desarrollador des) throws SQLException{
  //conectar cc = new conectar();
    ...
    JOptionPane.showMessageDialog(null, "El id del nuevo juego es " + cc.idJuego(jueg.getNombre()));
}
