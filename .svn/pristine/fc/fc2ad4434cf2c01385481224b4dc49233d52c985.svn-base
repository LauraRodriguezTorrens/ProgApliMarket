...
public class ComprarJuego2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(t_nick);
        t_nick.setBounds(220, 50, 264, 30);
        ...
        jPanel2.add(jLabel6);
        jLabel6.setBounds(452, 90, 52, 14);
        jPanel2.add(t_dia1);
        t_dia1.setBounds(298, 110, 30, 29);
        jPanel2.add(t_mes1);
        t_mes1.setBounds(372, 110, 29, 29);
        jPanel2.add(t_anio1);
        t_anio1.setBounds(452, 110, 30, 29);
...
boolean verificarCampos(){
    if(t_nick.getText().trim().length()==0){
    ...
    private void b_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_aceptarActionPerformed
       ...
       if(verificarCampos()){
           ...
           if(cli.existeN(t_nick.getText())){
           Controlador1 c1= Controlador1.getInstance();
           
           c1.realizarCompra(t_nick.getText(), obtenerFecha());
